...
const BOSS_DEFS := [
	{"name":"暗影守卫","hp":500.0,"speed":60.0,"touch":2.5,"exp":30.0,
	...
	{"name":"深渊领主","hp":700.0,"speed":70.0,"touch":3.5,"exp":38.0,
	...
	{"name":"虚空霸主","hp":900.0,"speed":55.0,"touch":4.0,"exp":45.0,
